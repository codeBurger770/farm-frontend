...
import { createLogicalOperatorThunk } from '../../redux/currentProject/thunks'

export default function CreateLogicalOperatorPage() {
    ...
    useEffect(() => {
        dispatch(setTypeAction('AND'))
        return () => dispatch(resetAction())
    }, [dispatch])

    const handleSubmit = e => {
        e.preventDefault()
        dispatch(createLogicalOperatorThunk(projectId))
    }
    ...
    return (
        <>
            ...
            <div className="container-fluid py-3">
                <h1 className="mb-3">Создать логический оператор</h1>
