...
import { changePassword1Thunk, changePassword2Thunk } from '../../redux/auth/thunks'
...
export default function ChangePasswordPage() {
    ...
    const handleSubmit = e => {
        ...
        if (!forms.isAwaitingConfirmationCode) {
            dispatch(changePassword1Thunk())
        } else {
            dispatch(changePassword2Thunk())
        }
    }
    ...
    return (
        <>
            ...
            <div className="container-fluid py-3">
                <h1 className="mb-3">Сменить пароль</h1>
                <form onSubmit={handleSubmit}>
                    ...
                    >
                        ...
                        <span className={forms.isLoading ? 'pl-2' : ''}>
                            {!forms.isAwaitingConfirmationCode ? 'Далее' : 'Сменить'}
                        </span>
                    </button>
                </form>
            </div>
